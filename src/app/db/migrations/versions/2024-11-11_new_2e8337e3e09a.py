...
def schema_upgrades() -> None:
    ...
    op.create_table('data_status',
    sa.Column('id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('last_update', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('next_update', sa.DateTimeUTC(timezone=True), nullable=True),
    sa.Column('status', sa.Enum('updated', 'out_of_date', name='statustype'), nullable=False),
    sa.Column('URL', sa.String(), nullable=False),
    sa.Column('cron', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_data_status'))
    )
